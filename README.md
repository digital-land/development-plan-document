# Development Plan Document pages
...
These pages are [updated nightly](https://github.com/digital-land/development-plan-document/actions) by the [GitHub Action](.github/workflows/run.yml).
